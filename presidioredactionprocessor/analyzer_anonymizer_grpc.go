...
func (s *presidioRedaction) callPresidioAnalyzerAndAnonymizer(ctx context.Context, requestPayload PresidioAnalyzerRequest) (PresidioAnonymizerResponse, error) {
